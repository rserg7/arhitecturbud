  ...
  <nav class="top-bar">
    ...
    <section class="top-bar-section">
      ...
      <ul>
        ...
        <li class="divider"></li>
        <li><a href="tech.html">Technologia</a></li>
        <li class="divider"></li>
...
<br/><br/>
  <div class="row" style="max-width:62.5em">
    <div class="large-12 columns">
      <h1 style="color:#000; font-size:72px">Kontakt</h1>
    </div>
  </div>
...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Arhitekturbud formularza opinii";
     
     
    function died($error) {
        // your error code can go here
        echo "<h2 style='color: white'>Bardzo nam przykro, ale błędy znajdują się w formularzu.</h2> ";
        echo "<h2 style='color: white'>Błędy są wymienione poniżej.</h2><br /><br />";
        echo $error."<br /><br />";
        echo "<h2 style='color: white'>Proszę wrócić i poprawić błędy.</h2><br /><br />";
		echo "
    <footer class='row'>
  <div class='large-12 columns'><hr />
      <div class='row'>
        ...
        <div class='large-4 columns center hide-for-small'>
          ...
          <p style='font-size:13px; line-height:10px; text-align:center'>Zastosowanie materiałów z zasobu możliwe jest tylko za pisemną zgodą właściciela</p>
          <p style='font-size:15px; line-height:6px; text-align:center; margin:0px; padding:0px'>2013 &copy; Wszelkie prawa zastrzeżone.</p>
          <p style='font-size:15px; line-height:35px; text-align:center; margin:0px; padding:0px'>Projekt został opracowany przez agencję <a href='http://www.core.lviv.ua'>CORE</a></p>
        </div>
    ...
    if(!isset($_POST['first_name']) ||
        ...
        died('Bardzo nam przykro, ale błędy znajdują się w formularzu.');       
    }
  ...
  if(!preg_match($email_exp,$email_from)) {
    $error_message .= '<p style="color: white">Błędny adres e-mail.</p><br />';
  }
  if(strlen($comments) < 2) {
    $error_message .= '<p style="color: white">Proszę wpisać wiadomość.</p><br />';
  }
...
<h1 style="padding-bottom:50px; line-height:20px">Skontaktujemy się z Państwem wkrótce. </h1>
<a href="index.html" style="color:#FFF">Powrót do domu</a>
