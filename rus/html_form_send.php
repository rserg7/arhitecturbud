  ...
  <nav class="top-bar">
    ...
    <section class="top-bar-section">
      ...
      <ul>
        ...
        <li class="divider"></li>
        <li><a href="tech.html">Технология</a></li>
        <li class="divider"></li>
...
<br/><br/>
  <div class="row" style="max-width:62.5em">
    <div class="large-12 columns">
      <h1 style="color:#000; font-size:72px">Контакты</h1>
    </div>
  </div>
...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Архитектурбуд форма обратной связи";
     
     
    function died($error) {
        // your error code can go here
        echo "<h2 style='color: white'>Нам очень жаль, но были найдены ошибки в форме.</h2> ";
        echo "<h2 style='color: white'>Ошибки представлены ниже.</h2><br /><br />";
        echo $error."<br /><br />";
        echo "<h2 style='color: white'>Пожалуйста вернитесь и исправьте ошибки.</h2><br /><br />";
		echo "
    <footer class='row'>
  <div class='large-12 columns'><hr />
      <div class='row'>
        ...
        <div class='large-4 columns center hide-for-small'>
          ...
          <p style='font-size:13px; line-height:10px; text-align:center'>Использовать материалы с ресурса возможно только с письменного согласия владельца</p>
          <p style='font-size:15px; line-height:6px; text-align:center; margin:0px; padding:0px'>2013 &copy; Все права сохранены.</p>
          <p style='font-size:15px; line-height:35px; text-align:center; margin:0px; padding:0px'>Проект разработан агентством <a href='http://www.core.lviv.ua'>CORE</a></p>
        </div>
    ...
    if(!isset($_POST['first_name']) ||
        ...
        died('Нам очень жаль, но были найдены ошибки в форме.');       
    }
  ...
  if(!preg_match($email_exp,$email_from)) {
    $error_message .= '<p style="color: white">Неправильный еmail адрес.</p><br />';
  }
  if(strlen($comments) < 2) {
    $error_message .= '<p style="color: white">Введите сообщение.</p><br />';
  }
...
<h1 style="padding-bottom:50px; line-height:20px">Мы свяжемся с Вами в ближайшее время. </h1>
<a href="index.html" style="color:#FFF">Вернуться на главную</a>
